...
const struct dfi_text_index_item *      dfi_text_index_binary_search                    (const struct dfi_index           *dfi,
                                                                                         const struct dfi_text_index      *text_index,
                                                                                         const gchar                      *string);
const dfi_id *                          dfi_text_index_item_get_ids                     (const struct dfi_index           *dfi,
